    ...
    private function configureLogsForPlaybackConfiguration(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                ...
                new \PHPStan\Type\Constant\ConstantStringType('AdsInteractionLog'),
                new \PHPStan\Type\Constant\ConstantStringType('ManifestServiceInteractionLog'),
            ], [
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    new \PHPStan\Type\Constant\ConstantStringType('PublishOptInEventTypes'),
                    new \PHPStan\Type\Constant\ConstantStringType('ExcludeEventTypes'),
                ], [
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantStringType('RAW_ADS_RESPONSE')),
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\UnionType([
                        new \PHPStan\Type\Constant\ConstantStringType('AD_MARKER_FOUND'),
                        new \PHPStan\Type\Constant\ConstantStringType('NON_AD_MARKER_FOUND'),
                        new \PHPStan\Type\Constant\ConstantStringType('MAKING_ADS_REQUEST'),
                        new \PHPStan\Type\Constant\ConstantStringType('MODIFIED_TARGET_URL'),
                        new \PHPStan\Type\Constant\ConstantStringType('VAST_REDIRECT'),
                        new \PHPStan\Type\Constant\ConstantStringType('EMPTY_VAST_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('EMPTY_VMAP_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('VAST_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('REDIRECTED_VAST_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('FILLED_AVAIL'),
                        new \PHPStan\Type\Constant\ConstantStringType('FILLED_OVERLAY_AVAIL'),
                        new \PHPStan\Type\Constant\ConstantStringType('BEACON_FIRED'),
                        new \PHPStan\Type\Constant\ConstantStringType('WARNING_NO_ADVERTISEMENTS'),
                        new \PHPStan\Type\Constant\ConstantStringType('WARNING_VPAID_AD_DROPPED'),
                        new \PHPStan\Type\Constant\ConstantStringType('WARNING_URL_VARIABLE_SUBSTITUTION_FAILED'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_UNKNOWN'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_UNKNOWN_HOST'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_DISALLOWED_HOST'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_IO'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_TIMEOUT'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_RESPONSE_PARSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_RESPONSE_UNKNOWN_ROOT_ELEMENT'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_INVALID_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_REDIRECT_EMPTY_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_REDIRECT_MULTIPLE_VAST'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_REDIRECT_FAILED'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MISSING_MEDIAFILES'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MISSING_CREATIVES'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MISSING_OVERLAYS'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MISSING_IMPRESSION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_INVALID_VAST_AD_TAG_URI'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MULTIPLE_TRACKING_EVENTS'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_MULTIPLE_LINEAR'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_VAST_INVALID_MEDIA_FILE'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_FIRING_BEACON_FAILED'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_PERSONALIZATION_DISABLED'),
                        new \PHPStan\Type\Constant\ConstantStringType('VOD_TIME_BASED_AVAIL_PLAN_VAST_RESPONSE_FOR_OFFSET'),
                        new \PHPStan\Type\Constant\ConstantStringType('VOD_TIME_BASED_AVAIL_PLAN_SUCCESS'),
                        new \PHPStan\Type\Constant\ConstantStringType('VOD_TIME_BASED_AVAIL_PLAN_WARNING_NO_ADVERTISEMENTS'),
                        new \PHPStan\Type\Constant\ConstantStringType('INTERSTITIAL_VOD_SUCCESS'),
                        new \PHPStan\Type\Constant\ConstantStringType('INTERSTITIAL_VOD_FAILURE'),
                    ])),
                ]),
                new \PHPStan\Type\Constant\ConstantArrayType([
                    new \PHPStan\Type\Constant\ConstantStringType('ExcludeEventTypes'),
                    ...
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\UnionType([
                        new \PHPStan\Type\Constant\ConstantStringType('GENERATED_MANIFEST'),
                        new \PHPStan\Type\Constant\ConstantStringType('ORIGIN_MANIFEST'),
                        new \PHPStan\Type\Constant\ConstantStringType('SESSION_INITIALIZED'),
                        new \PHPStan\Type\Constant\ConstantStringType('TRACKING_RESPONSE'),
                        new \PHPStan\Type\Constant\ConstantStringType('CONFIG_SYNTAX_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('CONFIG_SECURITY_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('UNKNOWN_HOST'),
                        new \PHPStan\Type\Constant\ConstantStringType('TIMEOUT_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('CONNECTION_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('IO_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('UNKNOWN_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('HOST_DISALLOWED'),
                        new \PHPStan\Type\Constant\ConstantStringType('PARSING_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('MANIFEST_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('NO_MASTER_OR_MEDIA_PLAYLIST'),
                        new \PHPStan\Type\Constant\ConstantStringType('NO_MASTER_PLAYLIST'),
                        new \PHPStan\Type\Constant\ConstantStringType('NO_MEDIA_PLAYLIST'),
                        new \PHPStan\Type\Constant\ConstantStringType('INCOMPATIBLE_HLS_VERSION'),
                        new \PHPStan\Type\Constant\ConstantStringType('SCTE35_PARSING_ERROR'),
                        new \PHPStan\Type\Constant\ConstantStringType('INVALID_SINGLE_PERIOD_DASH_MANIFEST'),
                        new \PHPStan\Type\Constant\ConstantStringType('UNSUPPORTED_SINGLE_PERIOD_DASH_MANIFEST'),
                        new \PHPStan\Type\Constant\ConstantStringType('LAST_PERIOD_MISSING_AUDIO'),
                        new \PHPStan\Type\Constant\ConstantStringType('LAST_PERIOD_MISSING_AUDIO_WARNING'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ORIGIN_PREFIX_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_ADS_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_LIVE_PRE_ROLL_ADS_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_CDN_AD_SEGMENT_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_CDN_CONTENT_SEGMENT_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_SLATE_AD_URL_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_PROFILE_NAME_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_BUMPER_START_INTERPOLATION'),
                        new \PHPStan\Type\Constant\ConstantStringType('ERROR_BUMPER_END_INTERPOLATION'),
                    ])),
                ]),
            ]),
        ]);
    ...
    private function createPrefetchSchedule(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                ...
                new \PHPStan\Type\Constant\ConstantStringType('RecurringPrefetchConfiguration'),
                new \PHPStan\Type\Constant\ConstantStringType('ScheduleType'),
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantStringType('EndTime'),
                    new \PHPStan\Type\Constant\ConstantStringType('StartTime'),
                    new \PHPStan\Type\Constant\ConstantStringType('TrafficShapingType'),
                    new \PHPStan\Type\Constant\ConstantStringType('TrafficShapingRetrievalWindow'),
                ], [
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\StringType()),
                    new \PHPStan\Type\ObjectType('DateTimeInterface'),
                    new \PHPStan\Type\ObjectType('DateTimeInterface'),
                    new \PHPStan\Type\Constant\ConstantStringType('RETRIEVAL_WINDOW'),
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('RetrievalWindowDurationSeconds'),
                    ], [
                        new \PHPStan\Type\IntegerType(),
                    ]),
                ]),
                new \PHPStan\Type\Constant\ConstantArrayType([
                    new \PHPStan\Type\Constant\ConstantStringType('StartTime'),
                    new \PHPStan\Type\Constant\ConstantStringType('EndTime'),
                    new \PHPStan\Type\Constant\ConstantStringType('RecurringConsumption'),
                    new \PHPStan\Type\Constant\ConstantStringType('RecurringRetrieval'),
                ], [
                    new \PHPStan\Type\ObjectType('DateTimeInterface'),
                    new \PHPStan\Type\ObjectType('DateTimeInterface'),
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('RetrievedAdExpirationSeconds'),
                        new \PHPStan\Type\Constant\ConstantStringType('AvailMatchingCriteria'),
                    ], [
                        new \PHPStan\Type\IntegerType(),
                        new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('DynamicVariables'),
                        new \PHPStan\Type\Constant\ConstantStringType('DelayAfterAvailEndSeconds'),
                        new \PHPStan\Type\Constant\ConstantStringType('TrafficShapingType'),
                        new \PHPStan\Type\Constant\ConstantStringType('TrafficShapingRetrievalWindow'),
                    ], [
                        new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\StringType()),
