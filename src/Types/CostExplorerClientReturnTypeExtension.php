...
final class CostExplorerClientReturnTypeExtension implements \PHPStan\Type\DynamicMethodReturnTypeExtension
{
    ...
    public function getTypeFromMethodCall(\PHPStan\Reflection\MethodReflection $methodReflection, \PhpParser\Node\Expr\MethodCall $methodCall, \PHPStan\Analyser\Scope $scope): ?\PHPStan\Type\Type
    {
        return match ((string) $methodCall->name) {
            ...
            'getCostAndUsageComparisons' => $this->getCostAndUsageComparisons(),
            'getCostAndUsageWithResources' => $this->getCostAndUsageWithResources(),
            'getCostCategories' => $this->getCostCategories(),
            'getCostComparisonDrivers' => $this->getCostComparisonDrivers(),
    ...
    private function getCostAndUsageComparisons(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                new \PHPStan\Type\Constant\ConstantStringType('CostAndUsageComparisons'),
                new \PHPStan\Type\Constant\ConstantStringType('TotalCostAndUsage'),
                new \PHPStan\Type\Constant\ConstantStringType('NextPageToken'),
            ], [
                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                    new \PHPStan\Type\Constant\ConstantStringType('CostAndUsageSelector'),
                    new \PHPStan\Type\Constant\ConstantStringType('Metrics'),
                ], [
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('Or'),
                    ...
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('BaselineTimePeriodAmount'),
                        new \PHPStan\Type\Constant\ConstantStringType('ComparisonTimePeriodAmount'),
    ...
    private function getCostComparisonDrivers(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                new \PHPStan\Type\Constant\ConstantStringType('CostComparisonDrivers'),
                new \PHPStan\Type\Constant\ConstantStringType('NextPageToken'),
            ], [
                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                    new \PHPStan\Type\Constant\ConstantStringType('CostSelector'),
                    new \PHPStan\Type\Constant\ConstantStringType('Metrics'),
                    new \PHPStan\Type\Constant\ConstantStringType('CostDrivers'),
                ], [
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('Or'),
                        new \PHPStan\Type\Constant\ConstantStringType('And'),
