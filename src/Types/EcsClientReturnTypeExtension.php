                    ...
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                            ...
                            new \PHPStan\Type\Constant\ConstantArrayType([
                                ...
                                new \PHPStan\Type\Constant\ConstantStringType('volumeInitializationRate'),
                ...
                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\UnionType([
                            ...
                            new \PHPStan\Type\Constant\ConstantStringType('WINDOWS_SERVER_2025_CORE'),
                            new \PHPStan\Type\Constant\ConstantStringType('WINDOWS_SERVER_2025_FULL'),
