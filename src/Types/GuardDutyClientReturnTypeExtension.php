                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantArrayType([
                            ...
                            new \PHPStan\Type\Constant\ConstantArrayType([
                                ...
                                new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                            ...
                            new \PHPStan\Type\Constant\ConstantArrayType([
                                ...
                                new \PHPStan\Type\Constant\ConstantStringType('AdditionalSequenceTypes'),
                            ], [
                                new \PHPStan\Type\StringType(),
                                new \PHPStan\Type\StringType(),
                                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                                ...
                                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                                    ...
                                    new \PHPStan\Type\UnionType([
                                        ...
                                        new \PHPStan\Type\Constant\ConstantStringType('EKS_CLUSTER'),
                                        new \PHPStan\Type\Constant\ConstantStringType('KUBERNETES_WORKLOAD'),
                                    ...
                                    new \PHPStan\Type\Constant\ConstantArrayType([
                                        ...
                                        new \PHPStan\Type\Constant\ConstantStringType('EksCluster'),
                                        new \PHPStan\Type\Constant\ConstantStringType('KubernetesWorkload'),
                                        new \PHPStan\Type\Constant\ConstantStringType('Container'),
                                    ], [
                                        new \PHPStan\Type\Constant\ConstantArrayType([
                                        ...
                                        new \PHPStan\Type\Constant\ConstantArrayType([
                                            ...
                                            new \PHPStan\Type\Constant\ConstantStringType('Status'),
                                            new \PHPStan\Type\Constant\ConstantStringType('VpcId'),
                                            new \PHPStan\Type\Constant\ConstantStringType('Ec2InstanceUids'),
                                        ], [
                                            new \PHPStan\Type\StringType(),
                                            new \PHPStan\Type\ObjectType('DateTimeInterface'),
                                            new \PHPStan\Type\UnionType([
                                        ...
                                        new \PHPStan\Type\Constant\ConstantArrayType([
                                            new \PHPStan\Type\Constant\ConstantStringType('ContainerUids'),
                                            new \PHPStan\Type\Constant\ConstantStringType('Namespace'),
                                            new \PHPStan\Type\Constant\ConstantStringType('KubernetesResourcesTypes'),
                                        ], [
                                            new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\StringType()),
                                            new \PHPStan\Type\StringType(),
                                            new \PHPStan\Type\UnionType([
                                                new \PHPStan\Type\Constant\ConstantStringType('PODS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('JOBS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('CRONJOBS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('DEPLOYMENTS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('DAEMONSETS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('STATEFULSETS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('REPLICASETS'),
                                                new \PHPStan\Type\Constant\ConstantStringType('REPLICATIONCONTROLLERS'),
                                            ]),
                                        ]),
                                        new \PHPStan\Type\Constant\ConstantArrayType([
                                            new \PHPStan\Type\Constant\ConstantStringType('Image'),
                                            new \PHPStan\Type\Constant\ConstantStringType('ImageUid'),
                                        ], [
                                            new \PHPStan\Type\StringType(),
                                            new \PHPStan\Type\StringType(),
                                        ]),
                                ...
                                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                                    ...
                                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                                        ...
                                        new \PHPStan\Type\UnionType([
                                            ...
                                            new \PHPStan\Type\Constant\ConstantStringType('SUSPICIOUS_PROCESS'),
                                            new \PHPStan\Type\Constant\ConstantStringType('MALICIOUS_DOMAIN'),
                                            new \PHPStan\Type\Constant\ConstantStringType('MALICIOUS_PROCESS'),
                                            new \PHPStan\Type\Constant\ConstantStringType('CRYPTOMINING_IP'),
                                            new \PHPStan\Type\Constant\ConstantStringType('CRYPTOMINING_DOMAIN'),
                                            new \PHPStan\Type\Constant\ConstantStringType('CRYPTOMINING_PROCESS'),
                                        ]),
                                        new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\StringType()),
                                        new \PHPStan\Type\StringType(),
                                    ])),
