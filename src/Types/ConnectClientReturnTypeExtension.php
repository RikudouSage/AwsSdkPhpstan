        ...
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantStringType('Recordings'),
                    new \PHPStan\Type\Constant\ConstantStringType('DisconnectReason'),
                    new \PHPStan\Type\Constant\ConstantStringType('ContactEvaluations'),
                    new \PHPStan\Type\Constant\ConstantStringType('ContactDetails'),
                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantStringType('AfterContactWorkDuration'),
                        new \PHPStan\Type\Constant\ConstantStringType('AfterContactWorkStartTimestamp'),
                        new \PHPStan\Type\Constant\ConstantStringType('AfterContactWorkEndTimestamp'),
                        new \PHPStan\Type\Constant\ConstantStringType('AgentInitiatedHoldDuration'),
                        new \PHPStan\Type\Constant\ConstantStringType('StateTransitions'),
                    ], [
                        new \PHPStan\Type\StringType(),
                        new \PHPStan\Type\ObjectType('DateTimeInterface'),
                        new \PHPStan\Type\IntegerType(),
                        ...
                        new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                            ...
                            new \PHPStan\Type\Constant\ConstantStringType('StateEndTimestamp'),
                        ], [
                            new \PHPStan\Type\UnionType([
                    ...
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantStringType('FragmentStartNumber'),
                        new \PHPStan\Type\Constant\ConstantStringType('FragmentStopNumber'),
                        new \PHPStan\Type\Constant\ConstantStringType('StartTimestamp'),
                        new \PHPStan\Type\Constant\ConstantStringType('StopTimestamp'),
                        new \PHPStan\Type\Constant\ConstantStringType('Status'),
                        new \PHPStan\Type\Constant\ConstantStringType('DeletionReason'),
                    ], [
                        new \PHPStan\Type\UnionType([
                    ...
                    new \PHPStan\Type\StringType(),
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\StringType(), new \PHPStan\Type\Constant\ConstantArrayType([
                        new \PHPStan\Type\Constant\ConstantStringType('FormId'),
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\UnionType([
                            ...
                            new \PHPStan\Type\Constant\ConstantStringType('OnSlaBreach'),
                        ]),
                        new \PHPStan\Type\StringType(),
                    ]),
                    new \PHPStan\Type\StringType(),
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantStringType('AssignSlaAction'),
                        ...
                        new \PHPStan\Type\UnionType([
                            ...
                            new \PHPStan\Type\Constant\ConstantStringType('ASSIGN_SLA'),
                        ...
                        new \PHPStan\Type\Constant\ConstantArrayType([
                            new \PHPStan\Type\Constant\ConstantStringType('SlaAssignmentType'),
                            new \PHPStan\Type\Constant\ConstantStringType('CaseSlaConfiguration'),
                        ], [
                            ...
                            new \PHPStan\Type\Constant\ConstantArrayType([
                                ...
                                new \PHPStan\Type\Constant\ConstantStringType('TargetSlaMinutes'),
                            ], [
                                new \PHPStan\Type\StringType(),
