        ...
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantArrayType([
                            ...
                            new \PHPStan\Type\UnionType([
                                ...
                                new \PHPStan\Type\Constant\ConstantStringType('RESERVATION_MODIFIED'),
                                new \PHPStan\Type\Constant\ConstantStringType('TAG_KEY'),
                                new \PHPStan\Type\Constant\ConstantStringType('COST_CATEGORY_NAME'),
                            ]),
                            new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\StringType()),
                    ...
                    new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\UnionType([
                        new \PHPStan\Type\Constant\ConstantStringType('BlendedCost'),
                        new \PHPStan\Type\Constant\ConstantStringType('UnblendedCost'),
                        new \PHPStan\Type\Constant\ConstantStringType('AmortizedCost'),
                        new \PHPStan\Type\Constant\ConstantStringType('NetUnblendedCost'),
                        new \PHPStan\Type\Constant\ConstantStringType('NetAmortizedCost'),
                        new \PHPStan\Type\Constant\ConstantStringType('UsageQuantity'),
                        new \PHPStan\Type\Constant\ConstantStringType('NormalizedUsageAmount'),
