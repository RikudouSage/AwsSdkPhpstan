...
final class ControlCatalogClientReturnTypeExtension implements \PHPStan\Type\DynamicMethodReturnTypeExtension
{
    /**
     * @return class-string<\Aws\ControlCatalog\ControlCatalogClient>
     */
    public function getClass(): string
    {
        return \Aws\ControlCatalog\ControlCatalogClient::class;
    }
        ...
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                ...
                new \PHPStan\Type\Constant\ConstantArrayType([
                    ...
                    new \PHPStan\Type\Constant\ConstantStringType('DeployableRegions'),
                ], [
                    new \PHPStan\Type\UnionType([
    ...
    private function listCommonControls(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                new \PHPStan\Type\Constant\ConstantStringType('CommonControls'),
                ...
                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\UnionType([
                    new \PHPStan\Type\Constant\ConstantArrayType([
                        ...
                        new \PHPStan\Type\Constant\ConstantStringType('Objective'),
    ...
    private function listObjectives(): ?\PHPStan\Type\Type
    {
        return new \PHPStan\Type\Generic\GenericObjectType('Aws\Result', [
            new \PHPStan\Type\Constant\ConstantArrayType([
                new \PHPStan\Type\Constant\ConstantStringType('Objectives'),
                new \PHPStan\Type\Constant\ConstantStringType('NextToken'),
            ], [
                new \PHPStan\Type\ArrayType(new \PHPStan\Type\IntegerType(), new \PHPStan\Type\UnionType([
                    new \PHPStan\Type\Constant\ConstantArrayType([
